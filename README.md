...
Il template sorgente è in `tools/Template_Doc_Progetto.docx`; il testo è in `tools/fill_template.py`. I rapporti automatici e i CSV nelle cartelle dei risultati sono artefatti sperimentali, e il Word raccoglie la relazione completa. Per rigenerarlo dopo aver completato i tre esperimenti:
